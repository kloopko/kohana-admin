 ...
 */
class View_Admin_Layout_ControllerNav extends View_Bootstrap_Nav {
	 ...
	 * @param	string	class which a controller must extend to get in the menu
	...
	{
		// If callback hasn't been specified, use default
	 ...
	 * @param	string	$parent key to prepend to each of child keys
	 * @return	array
	 */
